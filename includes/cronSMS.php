...
function sendSMS($from,$to,$message)
{
	...
	//http://www.myvaluefirst.com/smpp/sendsms?username=[xxxxxxxx]&password=[xxxxxxxx]&to=[xxxxxxxxxx]&udh=[xxxxxxxxx]&from=[xxxxxxxx]&text=[xxxxxxxxxxxxxxx]&dlr-url=[xxxxxxxxxxxxx]
