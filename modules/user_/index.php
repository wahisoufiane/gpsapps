...
<div class="wrapper"><!-- wrapper div start from here -->
	...
	<span>V 1.0</span>
        ...
        <div class="welcome_user">
            ...
            <?php } else { ?>
            <a class="active" href="#" onclick="location.href='?ch=profile';">Profile</a> 
            <?php } ?>
        ...
        <div id="dropmenu4" class="dropmenudiv" style="width: 150px;">
        	<a href="../tr/geo" target="_blank">Create</a>
            <a href="#" onclick="location.href='?ch=assignGeofence';">Assign</a>
        </div>
