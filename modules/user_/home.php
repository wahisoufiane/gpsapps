...
function exeRefreshHomeTable()
{
	...
	mapTable = '<table width="90%" class="gridform_final" border="0" cellpadding="2" cellspacing="2">';
    	mapTable +='<tr><th width="10%" align="left">Device</th><th width="22%" align="left">Device&nbsp;Name</th><th width="30%" align="left">Location</th><th width="12%" align="left">Lat Recv.</th><th width="8%" align="left">OdoMeter</th><th width="8%" align="left">Subscription Exp. Date</th><th width="5%" align="left">Status</th>';
	...
	if(ajax1.response != "")
	{
		...
		for(i=0;i<no_of_rows;i++)
		{
			...
			if(data[5]==0)
				status = '<img src="../tr/images/stop.gif" width="25px" height="25px" title="Stopped"/>';
			if(data[5]>0)
				status = '<img src="../tr/images/run.gif" width="25px" height="25px" title="Running"/>';
			else if(!data[5])
				status = '<img src="../tr/images/idle.gif" width="25px" height="25px" title="No data for today"/>';
			...
			mapTable +='<tr>';
			mapTable +='<td valign="top" align="left"><img src="unit_img/'+data[8]+'" width="75" height="75"/></td>';
			mapTable +='<td valign="top" align="left">'+data[1]+'</td>';
			mapTable +='<td  '+color+' valign="top" align="left">'+data[4]+'</td>';
			mapTable +='<td valign="top" align="left">'+data[6]+'</td>';
