...
<table class="form1">
    <tr>
        <td width="28%" class="formtext">Reseller Name </td>
  ...
  <tr>
        <td width="41%" class="formtext">GoogleMap API </td>
        <td align="center">  : </td> 
      	<td><input type="text" id="txtCGApi" name="txtCGApi" value="<?php echo $clientRecord[ci_googleApiKey];?>" /></td>
  </tr>
  
   <tr>
        <td width="41%" class="formtext">SMSGateway API </td>
        <td align="center">  : </td> 
      	<td><input type="text" id="txtSMSApi" name="txtSMSApi" value="<?php echo $clientRecord[ci_smsGatewayUri];?>" /></td>
  </tr>
  
   <tr>
        <td width="41%" class="formtext">SMSGateway API Username</td>
        <td align="center">  : </td> 
      	<td><input type="text" id="txtSMSUserName" name="txtSMSUserName" value="<?php echo $clientRecord[ci_smsGatewayUsername];?>" /></td>
  </tr>
  
   <tr>
        <td width="41%" class="formtext">SMSGateway API Password</td>
        <td align="center">  : </td> 
      	<td><input type="text" id="txtSMSPassword" name="txtSMSPassword" value="<?php echo $clientRecord[ci_smsGatewayPassword];?>" /></td>
  </tr>
    <tr>
        <td width="41%" class="formtext">SMSGateway API Sender ID</td>
        <td align="center">  : </td> 
      	<td><input type="text" id="txtSMSSenderId" name="txtSMSSenderId" value="<?php echo $clientRecord[ci_smsGatewaySenderId];?>" /></td>
  </tr>
   <tr>
        <td width="41%" class="formtext">SMTP Host Name</td>
        <td align="center">  : </td> 
      	<td><input type="text" id="txtSMTPHost" name="txtSMTPHost" value="<?php echo $clientRecord[ci_smtpHostname];?>" /></td>
  </tr>
  
   <tr>
        <td width="41%" class="formtext">SMTP Username </td>
        <td align="center">  : </td> 
      	<td><input type="text" id="txtSMTPUsername" name="txtSMTPUsername" value="<?php echo $clientRecord[ci_smtpUsername];?>" /></td>
  </tr>
  
   <tr>
        <td width="41%" class="formtext">SMTP Password</td>
        <td align="center">  : </td> 
      	<td><input type="text" id="txtSMTPPassword" name="txtSMTPPassword" value="<?php echo $clientRecord[ci_smtpPassword];?>" /></td>
  </tr>
