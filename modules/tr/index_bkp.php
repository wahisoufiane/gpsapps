...
<ul id="menu1">
    <li>
        ...
        <table class="detailsGrid">
          ...
          <tr><td align="center">
            ...
            <td><input type="checkbox" name="chkShowBubble" id="chkShowBubble" checked="checked" disabled="disabled" onchange="showPoints(this.id)" /><span id="shBub" class="green_link">Hide Points</span>
    ...
    <tr><td id="noSate">Satelite(s)&nbsp;: Null</td></tr>
     <tr><td id="Engine">Engine&nbsp;: Null</td></tr>
       <tr><td id="Fuel">Fuel(ltrs)&nbsp;: Null</td></tr>
