    ...
    <li>
        ...
        <table class="detailsGrid">
          ...
          <tr>
            ...
            <td align="left" style="float:left"><span style="float:left"><input type="text" readonly="readonly" id="time3" size="5" value="00:01" /></span></td>
          </tr>
          ...
          <tr>
          <td colspan="2"><strong>Total Distance -  <span id="totDist">0</span> km(s)</strong></td>
          </tr>
        </table>
        </form>
        </li>
