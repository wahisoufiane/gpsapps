...
if($db->affected_rows > 0){
	while($recordUserInfo = $db->fetch_array($resUserInfo))
	{
		...
		if($clientName == "ambicabuisnesssolutions")
		{
...
<div class="wrapper"><!--wrapper div start here -->
   <div class="introduce"><!-- introduce div START here-->
    <span class="version_top">v 1.0</span>
    	<div class="logoplace"><img src="http://122.183.93.232/gpsapp/modules/user/client_logo/<?php echo $clientLogo;?>" width="168" height="53" /></div>
    	<h3>What We Do</h3>
