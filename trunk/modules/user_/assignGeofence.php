...
<tr><th colspan="4">Assign Geofence</th></tr>
  <tr>
    ...
    <td width="25%" align="left">
        <select name="selGeofenceId" id="selGeofenceId" tabindex="1" style="width:100%" onchange="getDeviceGeofence(document.frm_map_filter.map_device_id.value,this.value);">
  ...
  <tr>    
    <td colspan="2" align="right">Alert when device 
       ...
       <td align="right">Status Active&nbsp;/&nbsp;Deactive</td>
       <td align="left"><input type="checkbox" name="chkStatusFlag" checked="checked" id="chkStatusFlag" /></td>
    </tr>             
    <tr>
