...
$rows = $db->query($sql);
	...
	?>
        ...
        <td><?php if($addFlag == 1) { ?><a href="#" onclick="funEditUser('<?php echo $record[tcs_id];?>','<?php echo $record[tcs_clientId];?>','<?php echo $record[tcs_deviceId];?>')">Edit</a><?php } else echo '--'; ?></td>
