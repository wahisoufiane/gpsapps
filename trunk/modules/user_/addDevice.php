...
function checkDevice(clientCond,condStr,val,id)
{
	if(clientCond)
		qry = "select * from tb_deviceinfo where "+clientCond+" AND "+condStr+" = '"+val+"'";
	else
		qry = "select * from tb_deviceinfo where "+condStr+" = '"+val+"'";
...
<div align="left" class="listofusers"><a href="#" onclick="location.href='?ch=viewDevice';">List of Device</a> / Add Device</div>
...
<table class="form1">
  ...
  <tr><td colspan="3" align="center">
      ...
      if(isset($_POST[txtDeviceId]) && $_POST[txtDeviceId] !='')
        {
        ?>
            <input type="submit" name="cmdSubmitUpdateDevice" id="cmdSubmitUpdateDevice" value="Update" class="click_btn" />  
      <?php } else { ?>
            <input type="submit" name="cmdSubmitAddDevice" id="cmdSubmitAddDevice" value="Submit" class="click_btn" />
