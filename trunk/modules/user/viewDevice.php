            ...
            <td valign="top"><table width="100%">
              <tr>
                <td align="left" style="border:0px;"><table width="100%">
                  <tr>
                    <td style="border:0px;"><span class="form_text">Device Id :</span> &nbsp; <?php echo $record[di_deviceId];?></td>
              ...
              <tr>
                <td style="border-bottom:0px; border-left:0px; border-right:0px;"><table width="100%">
                  <tr>
                    ...
                    <!--<td align="left" width="10%" style="border:0px;"><a class="error_strings" href="#" onclick="funEditUser('','<?php echo $_SESSION[clientID];?>','?ch=myalerts')">Edit Alerts</a></span></td>-->
                  </tr>
