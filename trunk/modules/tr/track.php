...
<div class="headerarea">
    ...
    <div class="status_message">
    	<input type="button" name="showAll" class="showlive_off" id="showAll" onclick="showMapForDate('<?php echo $date_offline;?>')" /><!--<input type="button" value="Close" class="login" onclick="window.close();" />-->
    </div>
  
  <div class="clear"></div>  
</div>
</div>
<div class="ui-layout-west" style="overflow-Y:scroll;">

    <table width="100%" class="detailsGrid" cols="1">
        <tr>
        <td>
        <div id="mapTable">Loading...</div>
        <div id="side_bar"></div>
        </td>
        </tr>
    </table>
...
<ul id="menu1">
    <li>
        ...
        <table class="detailsGrid">
          <tr><td><strong>Start Date & Time</strong></td></tr>
          <tr>
            <td><input type="text" name="from_date" id="from_date" size="10%" value="<?php echo $date_offline;?>" />
                <span><input type="text" readonly="readonly" id="time3" size="5" value="00:01" /></span>
            </td>
          </tr>
          <tr><td><strong>End Date & Time</strong></td></tr>
          <tr><td><input type="text" name="to_date" id="to_date" size="10%" value="<?php echo $date_offline;?>" />
                <span><input type="text" id="time4" size="5" readonly="readonly" value="23:59" /></span>
              </td></tr>
            <tr><td>
            <input type="hidden" name="hidTxtDevId" id="hidTxtDevId" />
            <input type="button" name="cmdFindData" id="cmdFindData" value="Find" disabled="disabled" onClick="showMapOnDate(document.getElementById('from_date').value,document.getElementById('time3').value,document.getElementById('to_date').value,document.getElementById('time4').value,document.getElementById('hidTxtDevId').value);" /></td>
            
          </tr>
          <tr>
          <td><b>Total Distance -  <span id="totDist">0</span> km(s)</b></td>
          </tr>
        </table>
        </form>
        </li>
