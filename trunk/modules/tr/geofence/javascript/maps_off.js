...
function addThisPoint(lt1,lng1)
{
	...
	if(flg1)
	{
		ajax1.requestFile = '../FMS/ajax_server.php?add_stop_name='+document.getElementById('txtMapPoint').value+'&mapPt1='+lt1+'&mapPt2='+lng1;
		//document.write(ajax1.requestFile);
		ajax1.onCompletion = function(){
		if(eval(ajax1.response) == 0)
		{
			ajax1.requestFile = '../FMS/ajax_server.php?mapLati='+lt1+'&mapLong='+lng1+'&mapPoint='+document.getElementById('txtMapPoint').value;
			//document.write(ajax1.requestFile);
