...
function load() {
  //if (GBrowserIsCompatible()) {
	var centerPoint = new GLatLng(19.129280,73.054280);
...
//map.addOverlay(polygon);
	...
	var polygon = new GPolygon(polyPoints,null,2,.5,"#aaaaff",.5);
	map.addOverlay(polygon);
...
function sendBackData()
{
	...
	else
	{
		...
		opener.document.getElementById('<?php echo $_GET[load_symbol]; ?>').innerHTML="<font color=green>Route Loaded</font>";
		window.close();
	}
}
