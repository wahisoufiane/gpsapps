<!-- AJAX JS STARTS -->
<script language="javascript" src="../modules/admin_exp/js/ajax.js"></script>
    ...
    if (point) 
	{
		...
		{   */   
			if(c==0)
			{
				...
				myHtml+="<a href='#' onclick='setStopPoint(c,"+point.y.toFixed(8) + "," + point.x.toFixed(8)+");'>set</a>";				
...
function setStopPoint(v1,pt1,pt2)
{
	var flg1=validThis(v1);
	if(flg1)
	{
		ajax1.requestFile = '../modules/admin_exp/ajax_server.php?add_stop_name='+document.getElementById('txtPoint'+(v1-1)).value+'&mapPt1='+pt1+'&mapPt2='+pt2;
...
var t=confirm("Are you sure to delete this stop:	"+stArr[index]);
	if(t)
	{
