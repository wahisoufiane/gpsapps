<!-- AJAX JS STARTS -->
<script language="javascript" src="../../FMS/modules/js/ajax.js"></script>
...
function setStopPoint(v1,pt1,pt2)
{
	...
	if(flg1)
	{
		ajax1.requestFile = '../../GPS/modules/ajax_server.php?add_stop_name='+document.getElementById('txtPoint'+(v1-1)).value+'&mapPt1='+pt1+'&mapPt2='+pt2;
