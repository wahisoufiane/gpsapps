...
function gpspathFunAll($date_offline,$deviceIMEI)
{
	...
	//$path1="http://localhost/gpsapp/data/".date('d-m-Y',strtotime($date_offline))."/352848024753440.txt";
...
if(strpos($str,"[2=1]") && $st_flag=='0')
{
	$st = substr($str,strpos($str,"[2=1]"),strlen($str));
...
if(strpos($str,"[2=0]") && $en_flag=='0')
{
	$en = substr($str,strpos($str,"[2=0]"),strlen($str));
...
<tr><th colspan="4">AC Report</th></tr>
  <tr>
